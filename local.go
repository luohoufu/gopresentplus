...
import (
	...
	"github.com/luohoufu/gopresentplus/tools"
	"golang.org/x/tools/playground/socket"
)

const basePkg = "github.com/luohoufu/gopresentplus"
...
func main() {
	...
	log.Printf("打开浏览器并访问 %s", origin.String())
...
func getPlusDirPath() string {
	...
	if runtime.GOOS == "windows" {
		plusDirPath = filepath.Join(usr.HomeDir, "presentplus")
	} else {
		plusDirPath = filepath.Join(usr.HomeDir, ".presentplus")
	}
